...
-- Table creation for classification
...
-- 1. Insert a new record to the account table (Tony Stark)
...
-- 5. Use an inner join to select make, model, and classification name for items in the 'Sport' category
...
-- 6. Update all inventory image paths to add '/vehicles' in the middle of the file path
UPDATE public.inventory
SET inv_image = REPLACE(inv_image, '/images/', '/images/vehicles/'),
    inv_thumbnail = REPLACE(inv_thumbnail, '/images/', '/images/vehicles/');

-- Copy queries 4 and 6 to the database rebuild file at the bottom of that file